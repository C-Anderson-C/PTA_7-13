...
int main() {
    ...
    bool hasLowerShadow = (Low < Open && Low < Close);  //利用布尔类型判断
    bool hasUpperShadow = (High > Open && High > Close);
